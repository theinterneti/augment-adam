"""Conversation visualization for the Dukat web interface.

This module provides functionality for visualizing conversations in the Dukat web interface.
        ...
        try:
            ...
            if export_format == "HTML":
                ...
                <head>
                    ...
                    <title>Dukat Conversation Visualization</title>
                </head>
                <body>
                    {content}
                </body>
