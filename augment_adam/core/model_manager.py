...
This module handles language model management and interaction.
"""
...
class ModelManager:
    """Manages language models for the Augment Adam assistant.
    
    This class provides a unified interface for interacting with different
    language models, both local and remote."""
