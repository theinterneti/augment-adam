#!/usr/bin/env python3
"""
Simple script to generate plugin system architecture documentation.
...
# Load the plugin system architecture data
data_path = Path("docs/data/plugin_system_arch.json")
...
# Save the output
output_path = Path("docs/architecture/PLUGIN_SYSTEM.md")
