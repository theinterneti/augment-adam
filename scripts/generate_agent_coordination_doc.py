#!/usr/bin/env python3
"""
Simple script to generate agent coordination architecture documentation.
...
# Load the agent coordination architecture data
data_path = Path("docs/data/agent_coordination_arch.json")
...
# Save the output
output_path = Path("docs/architecture/AGENT_COORDINATION.md")
