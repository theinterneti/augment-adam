#!/usr/bin/env python3
"""
Simple script to generate context engine architecture documentation.
...
# Load the context engine architecture data
data_path = Path("docs/data/context_engine_arch.json")
...
# Save the output
output_path = Path("docs/architecture/CONTEXT_ENGINE.md")
