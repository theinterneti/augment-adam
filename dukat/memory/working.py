...
class Message:
    ...
    def __init__(
        ...
        logger.debug(f"Created message with role {role} and timestamp {self.timestamp}")
...
class WorkingMemory:
    ...
    def __init__(
        ...
        logger.info(f"Initialized working memory with conversation_id: {self.conversation_id}")
