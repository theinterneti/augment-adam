"""FAISS-based memory for the Dukat assistant.
...
class FAISSMemory:
    ...
    def __init__(
        ...
        self.persist_dir = persist_dir or os.path.expanduser("~/.dukat/memory/faiss")
        self.default_collection = collection_name or "dukat_memory"
...
def get_faiss_memory(
    ...
    try:
        if default_memory is None:
            ...
            # Use provided values or defaults from settings
            persist_dir = persist_dir or os.path.expanduser("~/.dukat/memory/faiss")
