...
class WebInterface:
    ...
    def _user_input_callback(
        ...
        # Generate a response
        response = self.assistant.generate_response(system_prompt=system_prompt)
    ...
    def create_interface(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                with gr.Column(scale=3):
                    ...
                    conversation_display = gr.HTML(
                        ...
                        value=self._format_conversation(self.conversation_history),
                    )
                ...
                with gr.Column(scale=1):
                    ...
                    system_prompt = gr.Textbox(
                        ...
                        lines=3,
                        value=self.config.get("system_prompt", "You are Dukat, an open-source AI assistant focused on personal automation."),
                    )
            ...
            refresh_button.click(
                fn=lambda: gr.update(choices=self._get_available_models_callback()),
                inputs=[],
