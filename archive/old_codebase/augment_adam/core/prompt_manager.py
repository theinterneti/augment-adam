"""Prompt management for the Augment Adam assistant.
...
class PromptManager:
    ...
    def _init_default_templates(self) -> None:
        ...
        self.add_template(
            name="conversation",
            template=(
                "You are a helpful AI assistant named Augment Adam. "
        ...
        self.add_template(
            name="tool_use",
            template=(
                "You are a helpful AI assistant named Augment Adam with access to tools. "
