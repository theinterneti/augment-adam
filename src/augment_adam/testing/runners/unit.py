...
This module provides a runner for unit tests, which test individual components
in isolation.
"""
...
from augment_adam.testing.utils.loader import UnitTestLoader
from augment_adam.testing.utils.suite import UnitTestSuite
...
class UnitTestRunner:
    ...
    def __init__(
        ...
        loader: Optional[UnitTestLoader] = None
    ) -> None:
        """
        ...
        self.loader = loader or UnitTestLoader()
    ...
    def discover_and_run(self, start_dir: str = "tests/unit", pattern: str = "test_*.py", top_level_dir: Optional[str] = None) -> TestResult:
        """
