...
This module provides a runner for integration tests, which test interactions
between components.
"""
...
from augment_adam.testing.utils.loader import IntegrationTestLoader
from augment_adam.testing.utils.suite import IntegrationTestSuite
...
class IntegrationTestRunner:
    ...
    This class provides a runner for integration tests, which test interactions
    between components.
    ...
    def __init__(
        ...
        loader: Optional[IntegrationTestLoader] = None
    ) -> None:
        """
        ...
        self.loader = loader or IntegrationTestLoader()
    ...
    def discover_and_run(self, start_dir: str = "tests/integration", pattern: str = "test_*.py", top_level_dir: Optional[str] = None) -> TestResult:
        """
