...
spec = importlib.util.spec_from_file_location("augment_adam.cli_module", os.path.abspath(os.path.join(os.path.dirname(__file__), '../../augment_adam/cli.py')))
module = importlib.util.module_from_spec(spec)
sys.modules["augment_adam.cli_module"] = module
...
@patch('augment_adam.cli_module.Assistant')
...
@patch('augment_adam.cli_module.launch_web_interface')
