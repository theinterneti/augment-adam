    ...
    def test_bitsandbytes_installation(self):
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                assert bnb.cuda.COMPILED_WITH_CUDA, "bitsandbytes not compiled with CUDA support"
        except ImportError:
    ...
    def test_environment_variables(self):
        ...
        if transformers_cache:
            ...
            try:
                ...
                pytest.fail(f"TRANSFORMERS_CACHE directory {transformers_cache} is not writable: {e}")
        ...
        if hf_home:
            ...
            # Try to create a test file
            test_file = hf_dir / "test_file.txt"
            try:
                with open(test_file, 'w') as f:
                    f.write("Test content")
                test_file.unlink()
            except Exception as e:
                pytest.fail(f"HF_HOME directory {hf_home} is not writable: {e}")
