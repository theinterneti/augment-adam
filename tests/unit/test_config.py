...
from dukat.config import Config, MemoryConfig, load_config, save_config
...
def test_default_config():
    ...
    assert config.memory.persist_dir == "~/.dukat/memory"
...
def test_custom_config():
    ...
    assert config.memory.persist_dir == "/tmp/dukat/memory"
