...
class TestMetropolisHastings(unittest.TestCase):
    ...
    def test_instantiation(self):
        ...
        self.assertIsInstance(self.instance, MetropolisHastings)
    ...
    def test___init___basic(self):
        ...
        # self.assertEqual(instance.proposal_distribution, proposal_distribution)
    ...
    @patch("augment_adam.monte_carlo.mcmc.samplers.random")
    @patch("augment_adam.monte_carlo.mcmc.samplers.math")
    def test_sample_with_mocks(self, mock_random, mock_math):
...
class TestGibbsSampler(unittest.TestCase):
    ...
    def test_instantiation(self):
        """Test that the class can be instantiated."""
        self.assertIsInstance(self.instance, GibbsSampler)
    ...
    def test___init___basic(self):
        ...
        # Check if instance attributes are set correctly
        # self.assertEqual(instance.target_log_prob_fn, target_log_prob_fn)
        # self.assertEqual(instance.conditional_samplers, conditional_samplers)
        # self.assertEqual(instance.name, name)
...
class TestHamiltonianMC(unittest.TestCase):
    ...
    def test_instantiation(self):
        """Test that the class can be instantiated."""
        self.assertIsInstance(self.instance, HamiltonianMC)
    ...
    def test___init___basic(self):
        ...
        # Check if instance attributes are set correctly
        # self.assertEqual(instance.target_log_prob_fn, target_log_prob_fn)
        # self.assertEqual(instance.target_log_prob_grad_fn, target_log_prob_grad_fn)
        # self.assertEqual(instance.step_size, step_size)
        # self.assertEqual(instance.num_steps, num_steps)
        # self.assertEqual(instance.name, name)
