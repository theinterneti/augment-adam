...
class TestErrorLogging(unittest.TestCase):
    ...
    def test_log_dukat_error(self):
        ...
        self.assertEqual(kwargs["extra"]["message"], "Test error")
...
class TestRetryDecorator(unittest.TestCase):
    ...
    def test_retry_with_on_retry_callback(self):
        ...
        decorated = retry(max_attempts=3, delay=0.01, on_retry=on_retry_mock)(mock_func)
...
class TestCircuitBreaker(unittest.TestCase):
    ...
    def test_half_open_after_timeout(self):
        ...
        mock_func = MagicMock(side_effect=[ValueError("Error"), ValueError("Error"), "success"])
    ...
    def test_failure_in_half_open(self):
        ...
        mock_func = MagicMock(side_effect=[ValueError("Error"), ValueError("Error"), ValueError("Error")])
