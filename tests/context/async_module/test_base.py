...
class TestAsyncContextTask(unittest.TestCase):
    ...
    @patch("augment_adam.context.async_module.base.time")
    @patch("augment_adam.context.async_module.base.uuid")
    def test_from_dict_with_mocks(self, mock_time, mock_uuid):
...
class TestAsyncContextBuilder(unittest.TestCase):
    ...
    @patch("augment_adam.context.async_module.base.dependency")
...
class TestAsyncContextManager(unittest.TestCase):
    ...
    @patch("augment_adam.context.async_module.base.queue")
